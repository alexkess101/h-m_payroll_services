        ...
        return (
            <div className='navbar-container'>
                <div className="navbar-wrapper">
                    <Controller>
                        <Scene classToggle={['.link', 'reveal']} triggerElement={'#trigger'} reverse={false}>
                            <Timeline>
                                <Tween 
                                    wrapper={
                                ...
                                >
                                    <div className="links-wrapper">
                                        <img src="https://res-console.cloudinary.com/akbottega/thumbnails/v1/image/upload/v1558655467/bG9nb19ub193b3Jkcw==/preview" alt="logo"/>
